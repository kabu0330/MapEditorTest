...
public:
	...
	void View(const FVector& _Pos, const FVector& _Dir, const FVector& _Up)
	{
		...
		// -90
		ArrVector[2] = _Dir.NormalizeReturn();
		ArrVector[1] = _Up.NormalizeReturn();
		ArrVector[0] = FVector::Cross(ArrVector[1], ArrVector[2]);
		...
		FVector Right = ArrVector[0];
		FVector Up = ArrVector[1];
		FVector Forward = ArrVector[2];
